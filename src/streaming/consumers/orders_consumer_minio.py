...
# SUBMIT COMMAND
# docker exec -it spark_worker spark-submit --packages org.apache.hadoop:hadoop-aws:3.3.2 --packages org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.0 /consumer/orders_consumer_minio.py
